...
Este documento describe cómo reportar vulnerabilidades en **udd-api-node** y qué prácticas de seguridad seguimos en el repositorio.
...
- **Email**: <contact@brayandiazc.com> (preferido — usa un asunto que empiece con `Security:` para priorizarlo).
...
| Releases / tags         | Solo la última versión etiquetada recibe correcciones |
...
- Ejecuta auditorías de vulnerabilidades automáticas en CI (npm audit).
...
- **Reportes de seguridad**: <contact@brayandiazc.com> (asunto: `Security: …`)
- **Consultas generales**: <contact@brayandiazc.com>
